const keys = {
  up: { linux: 103, macOS: 126, windows: 38 },
  down: { linux: 108, macOS: 125, windows: 40 },
  left: { linux: 105, macOS: 123, windows: 37 },
  right: { linux: 106, macOS: 124, windows: 39 },
  backspace: { linux: 14, macOS: 51, windows: 8 },
  enter: { linux: 28, macOS: 76, windows: 13},
  ...
  spacebar: { linux: 57, macOS: 49, windows: 32 },
  shift: { linux: 42, macOS: 56, windows: 160 },
  shiftRight: { linux: 54, macOS: 60, windows: 161 },
  control: { linux: 29, macOS: 59, windows: 162 },
  menu: { linux: 139, macOS: 58, windows: 93 },
  printScreen: { linux: 210, macOS: '*', windows: 44 },
  ...
  backslash: {linux: 43, macOS: 42, windows: 220},
  rightsqure: {linux: 27, macOS: 30, windows: 221},
  leftsqure: {linux: 26, macOS: 33, windows: 219},
  accent: {linux: 41, macOS: 50, windows: 192},
  minus: {linux: 12, macOS: 27, windows: 189},
  equals: {linux: 13, macOS: 24, windows: 187},
  semiconlon: {linux: 39, macOS: 41, windows: 186},
  "'": {linux: 40, macOS: 39, windows: 222},
