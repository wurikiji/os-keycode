const keys = {
  ...
  shift: { linux: 42, macOS: 56, windows: 10 },
  shiftRight: { linux: 54, macOS: 60, windows: '*' },
  control: { linux: 29, macOS: 59, windows: 11 },
  ...
  backslash: {linux: 43, macOS: 42, windows: '*'},
  rightsqure: {linux: 27, macOS: 30, windows: '*'},
  leftsqure: {linux: 26, macOS: 33, windows: '*'},
  accent: {linux: 41, macOS: 50, windows: '*'},
  minus: {linux: 12, macOS: 27, windows: '*'},
  equals: {linux: 13, macOS: 24, windows: '*'},
  semiconlon: {linux: 39, macOS: 41, windows: '*'},
  "'": {linux: 40, macOS: 39, windows: '*'},
